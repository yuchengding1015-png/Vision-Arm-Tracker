...
![alt text](https://img.shields.io/badge/MediaPipe-Latest-orange.svg)


![alt text](https://img.shields.io/badge/Intel%20RealSense-Supported-blue)
...
Connect the RealSense camera and the robotic arm's control board to your PC via USB.

Open the config.py file and modify the following parameters according to your setup:
